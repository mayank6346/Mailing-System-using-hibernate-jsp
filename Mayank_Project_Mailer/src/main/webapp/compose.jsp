<%@page import="src.main.java.Register"%>
...
String w=(String) session.getAttribute("frm");
			...
			<form action="<%=request.getContextPath()%>/compose" method="post">
				...
				<div class="form-group">
					<label for="from">FROM :</label> <input type="email"
						class="form-control" id="from" name="from"  value="<%=w%>" readonly >
				</div>
				...
				<div class="row">
					<div class="col-md-8 offset-md-2">
    <button type="submit" formaction="<%=request.getContextPath()%>/draft" class="btn btn-primary col-4 ml-4 ">Draft</button>
